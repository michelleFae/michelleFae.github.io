var padding = {top:20, right:40, bottom:0, left:0},
            ...
            var data = [
                    {"label":"Sing a Song 1",  "value":1,  "question":"(8 people) As a group, sing a song in front of everyone here. Pick one of three songs: I want it that way (backstreet boys), Twinkle Twinkle Little Star (Nursery Rhyme), or Bad Guy (Billie Eilish)"}, // padding
                    {"label":"Dance Away",  "value":2,  "question":"(10 people) Do the Chicken dance infront of everyone (https://www.youtube.com/watch?v=l5sIspLfmXM)."},
                    {"label":"Piazza Post",  "value":3,  "question":"(8 people) Choose any one of your classes and publicly post an image of a whale on the class's Piazza. You are not allowed to disclose that this is a candidate challenge until tomorrow morning. In fact, the only thing that you can write on the post is 'I love whales.'"}, //color
                    {"label":"Sing a Song 2",  "value":4,  "question":"(8  people) As a group, sing a song infront of everyone here. Pick one of three songs: Don't stop believing (Journey), Any nursery rhyme of your choice, or we will rock you (Queen)"}, //font-weight
                    ...
                    {"label":"Drawing Blind",  "value":7,  "question":"(10 people) Close your eyes and draw a picture of a whale on your computer in 20 seconds. The person who draws the best picture gets checked off (we all will vote). You can use paint or https://sketch.io/sketchpad/ for a drawing canvas. Then, post the picture on #random."},
                    {"label":"Draw an Officer",  "value":8,  "question":"(10 people) With your eyes open, draw a picture of any one officer on your computer. The person who draws the best picture gets checked off (we all will vote). You can use paint or https://sketch.io/sketchpad/ for a drawing canvas. Then, post the picture on #random."}, //bottom
                    ...
                    {"label":"Piazza Comment",  "value":10,  "question":"(8 people) Comment on a recent piazza post with the phrase: 'Whale, isn't that whaley nice to hear?'"},
                    ...
                    {"label":"Message a member",  "value":14,  "question":"(8 people) Slack message a UPE member that is not at GM with the phrase: 'Whale hello! Why didn't you come to GM?'. You can't disclose that this is a candidate challenge until tomorrow morning."}, //bottom
                    ...
                    {"label":"Slack Profile Pictures",  "value":16,  "question":"(5 people) Change your UPE Slack profile picture to a whale for the rest of the week. You can change it back next monday."},
                    ...
                    {"label":"Ask the Audience",  "value":18,  "question":"(2 people) Anyone in the audience can give you a challenge, which you can complete now or later."},
                    ...
                    {"label":"May the Best Meme Win ",  "value":20,  "question":"(5 people) Make a UPE releated meme and post it in #random. Each person has to make their own meme. After I spin the wheel 2 more times, we'll vote for the best meme. The winning creator will get their candidate challenge checked off."}, //bottom
                    {"label":"Ketchup Dance",  "value":21,  "question":"(5 people) Do the Ketchup song dance for a minute (https://www.youtube.com/watch?v=bxOyZnkFdWw)"},
                    {"label":"Hold it!",  "value":22,  "question":"(8 people) Say the word 'UPEeeee...' for as long as you can, in a single breath. The candidate who holds the word for the longest time gets checked off for the challenge."},
                    ...
                    {"label":"The Chosen One",  "value":25,  "question":"(10 people) Place your hands on your keyboard. You have 10 seconds to make a choice. You can either DM Michelle with the character '!'.  If only one candidate does this, that one candidate gets checked off, while the others do not. If more than one candidate does this, no one gets checked off. If no candidate does this, we flip a coin to decide whether we check off all candidates or none of them. If you decide to not DM michelle with '!', DM her with the character '@'. "},
                    ...
                    {"label":"UPE Jingle",  "value":27,  "question":"(3 people) Each of you should write & sing your own UPE jingle (An example of a jingle is a catchy rhyme to get you to buy a product). Feel free to use this (https://www.google.com/doodles/44th-anniversary-of-the-birth-of-hip-hop) - lemme quickly demo it rn. We'll hear all your jingles at the end of the bingo game."},
                    {"label":"Whale Rhymes",  "value":28,  "question":"(6 people) Each person has to say an english word that rhymes with whale. On their turn, they each have 5 seconds to come up with the rhyming word, ensuring not to repeat a word. If you can't come up with a word in that time, you're out of this mini-game and lose your chance to get checked off. The last person standing wins. You can't repeat a word."},
                    {"label":"Whale Dance", "value":29,  "question":"(8 people) Do this super fun whale dance (It's super easy and fun ... i don't usually dance, but this is a dance I'd totally do) - https://www.youtube.com/watch?v=Parej8Fi0es"}, 
                    {"label":"Whale zoom background",  "value":30,  "question":"(8 people) Create / find a whaley nice whale zoom background and post it on #random. Two wheel spins from now, we'll vote for the best one and the winner gets checked off!"},
                    {"label":"Whale Tune",  "value":31,  "question":"(5 people) Use this (https://musiclab.chromeexperiments.com/Song-Maker) to create a whaley nice tune. We'll check out all your songs 2 spins from now."},
                    {"label":"Longest Word",  "value":32,  "question":"(10 people) Create the longest word that you can using the following letters: 'whales are wonderful' and dm it to michelle (e.g. you can make the word 'falls'). The person with the longest word gets checked off. However, if there are multiple words of the same length, they are automatically disqualified. You have to submit your word before the next spin - so start thinking asap."}, //bottom
                    {"label":"Whaley Whale Memory",  "value":33,  "question":"(8 people) Watch this video once (https://www.youtube.com/watch?v=wrO6ZrB8sY8). Then be quizzed on things you saw in the video. Can you remember them all?"}
        ];
